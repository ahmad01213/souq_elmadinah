...
@section('content')
    <div class="card-body align-content-center" style="justify-content: space-around">
        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <a class="btn btn-success order-delete" style="margin-bottom: 10px;float: right" href="{{route('users.create')}}" id="2">
                         إضافة عضو  +
                    </a>
...
{{--                                            حذف--}}
{{--                                        </a>--}}
                                        <a class="btn btn-primary order-delete" href="{{ route('users.edit', ['user'=>$row->id]) }}" id="2" style="height: 40px; border-radius: 15px">
                                            تعديل
                                        </a>
                                    </div>
                                </td>
