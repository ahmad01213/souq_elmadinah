...
@section('content')
    <div class="card-body align-content-center" style="justify-content: space-around">
        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <a class="btn btn-success order-delete" style="margin-bottom: 10px;float: right" href="{{route('categories.create')}}" id="2">
                         إضافة قسم  +
                    </a>
                            ...
                            <tr role="row" class="odd" align="center">
                                <td align="center" tabindex="0" class="sorting_1" style="text-align: center;width: 200px;">
                                    <div class="container" style=" display: flex;justify-content:center;">
                                        ...
                                        <form action="{{ route('categories.destroy' , ['category' => $row->id]) }}" method="post">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
...
{{--                                            حذف--}}
{{--                                        </a>--}}
                                        <a class="btn btn-primary order-delete" href="{{ route('categories.edit', ['category'=>$row->id]) }}" id="2" style="height: 40px; border-radius: 15px">
                                            تعديل
                                        </a>
                                    </div>
                                </td>
