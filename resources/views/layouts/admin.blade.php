...
<head>
    ...
    <title>Souq El Madinah | Dashboard</title>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">يحيي الحربي</a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item ">
                        <a href="{{route('subcategories.index')}}" class="nav-link {{ is_active('subcategories') }}">
                    ...
                    <li class="nav-item ">
                        <a href="{{route('ads.index')}}" class="nav-link {{ is_active('ads') }}">
                    ...
                    <li class="nav-item ">
                        <a href="{{route('ads.sus')}}" class="nav-link {{ is_active('getsuspendedadds') }}">
